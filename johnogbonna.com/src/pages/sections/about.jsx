    ...
    return (
        <div className="About" id="section">
            ...
            <div className="section" id="Bio">
                ...
                <div className="section_paragraph-images">
                    <figure className="section_paragraph-image--about" id='about_image2'>
                        <img className="sectionImage" id="aboutImage" src={fam_photo9} alt='family' />
            ...
            <div className="section_paragraphWrapper">
                ...
                <div className="section_paragraph-images">
                    <figure className="section_paragraph-image--about">
                        <img className="sectionImage" id="aboutImage" src={grad_photoHS1} alt="High School Grad" />
            ...
            <div className="section" id="University">
                ...
                <div className="section_paragraphWrapper">
                    <div className="section_paragraph-images" id='middleImage'>
                        <figure className="section_paragraph-image--about">
                            <img className="sectionImage" id="aboutImageMiddle" src={other_photo1} alt="University Capstone" />
                            <figcaption className={`section_paragraph-caption${props.theme.color}`} alt='university project'>My group and I holding our final capstone project. We made a model house with a simulated security system that could be conrolled remotely using a cellphone app.  </figcaption>
                        </figure>
                    </div>
                ...
                <div className="section_paragraphWrapper">
                    ...
                    <div className="section_paragraph-images">
                        <figure className="section_paragraph-image--about">
                            <img className="sectionImage" id="aboutImage" src={grad_photo4} alt='university' />
                ...
                <figure className="section_paragraph-image--about">
                    <img className="sectionImage" id="aboutImage" src={grad_photo1} alt="University Grad" />
            ...
            <div className="section" id="After University">
                <div className="section_content">
                    ...
                    <div className="section_paragraphWrapper">
                        ...
                        <div className="section_paragraph-images">
                            <figure className="section_paragraph-image--about">
                                <img className="sectionImage" id="aboutImage" src={self_photo8} alt="Selfie at Virgin Mobile" />
                                <figcaption className={`section_paragraph-caption${props.theme.color}`}>Selfie I took, working at Virgin Mobile (now called Virgin Plus)</figcaption>
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <div className="section" id="Learning Software Development">
                <div className="section_content">
                    ...
                    <div className="section_paragraphWrapper" id="brainstation">
                        ...
                        <div className="section_paragraph-images">
                            <figure className="section_paragraph-image--about">
                                <img className="sectionImage" id={`aboutImageLogo${props.darkMode ? 'Dark' : ''}`} src={brainstation_logo} alt="brainstation" />
